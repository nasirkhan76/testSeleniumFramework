...
class HtmlEditor2 extends JFrame
{
  //Setting up column names, must be changed from here.
  String colNames[] = {"",
                        "<HTML>Row<BR> switch</HTML>",
                        "Comment",
                        "Locator Type",
                        "Locator Text",
                        "<HTML>Innertext</HTML>",
                        "Action",
                        "Input Value",
                        "<HTML>Wait for<BR>Element(Secs)</HTML>",
                        "Action Result",
                        "Error Message:",
                        "Output",
                        "Result Name"};
  ...
  private String currentPath = "C:\\Projects\\testSeleniumFramework\\src\\test\\specs\\com\\automatedTest";
  JFrame frame;
  ...
  public HtmlEditor2()
    ...
    addWindowListener ( new WindowAdapter() {
        ...
        public void windowClosing ( WindowEvent e ) {
            try {
                ...
                Logger.getLogger(HtmlEditor2.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    });
    ...
    comboBox.addItem("checkattribute");
    comboBox.addItem("checktext");
    comboBox.addItem("checktitle");
    comboBox.addItem("checkvalue");
    comboBox.addItem("click");
    comboBox.addItem("close");
    comboBox.addItem("containstext");
    comboBox.addItem("deselectall");
    comboBox.addItem("doesnotexist");
    comboBox.addItem("doubleclick");
    comboBox.addItem("endtest");
    comboBox.addItem("exists");
    comboBox.addItem("getattribute");
    comboBox.addItem("getcurrenttime");
    comboBox.addItem("getipaddress");
    comboBox.addItem("getlocation");
    comboBox.addItem("getsize");
    comboBox.addItem("gettagname");
    comboBox.addItem("gettext");
    comboBox.addItem("getvalue");
    comboBox.addItem("navigate");
    comboBox.addItem("select");
    comboBox.addItem("sendkeys");
    comboBox.addItem("sendkeyswithnewline");
    comboBox.addItem("set");
    comboBox.addItem("setasrootelement");
    comboBox.addItem("wait");
...
public void outputFileAs () throws IOException
    ...
    int result1 = fc.showSaveDialog(HtmlEditor2.this);
    switch (result1)
        {
...
public void save() throws IOException
    {
        ...
        BufferedWriter bw = new BufferedWriter(new FileWriter(this.title)); Throwable localThrowable2 = null;
...
public void importFile() throws IOException
    ...
    fc.addChoosableFileFilter(filterhtml);
    fc.setFileFilter(filterhtml);
    int result1 = fc.showOpenDialog(HtmlEditor2.this);
    switch (result1)
        {
        case JFileChooser.APPROVE_OPTION:
        file = fc.getSelectedFile();
...
public void exit() throws IOException
    {
        ...
        int exitQuestion = JOptionPane.showConfirmDialog
            (null,"Do you wish to save changes?\n" + "If No this session will be saved to C:\\Temp.html", "Exit", JOptionPane.YES_NO_CANCEL_OPTION);
...
class PopUpDemo extends JPopupMenu
    ...
    JMenuItem addRA, addRB, delR, copR, pasR, pasRB, clrR, copC, pasC, clrC;
    public PopUpDemo()
        {
...
public final void initUI()
    ...
    about.addActionListener(new ActionListener()
        ...
        public void actionPerformed(ActionEvent event)
            {
            JOptionPane.showMessageDialog(frame,"Version : 2.1\n\nFor support contact : thomas.barnes@practicallaw.com","HTML Editor",JOptionPane.PLAIN_MESSAGE);
            }
        });
        fileM.add(newM);
        fileM.add(openM);
...
public static void main(String[] args)
    {
    new HtmlEditor2().setVisible(true);
    }
}