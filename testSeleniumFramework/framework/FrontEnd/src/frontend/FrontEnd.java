...
class FrontEnd extends JFrame
{
    ...
    private JCheckBox duplC;
    private JButton openF, openFo, selFo, canF, Launch, foSel;
    ...
    private void doLaunch() throws IOException
        ...
        if (reply == JOptionPane.YES_OPTION)
            ...
            if (selFoFl == 0)
                {
                try (BufferedWriter bw = new BufferedWriter(new FileWriter("C:\\Projects\\testSeleniumFramework\\framework\\runSelectedTests.bat")))
                    {
                    if (numRow<2)
                        {
                ...
                pullS = "";
                Process p = Runtime.getRuntime().exec("cmd /c start C:\\Projects\\testSeleniumFramework\\framework\\runSelectedTests.bat");
                }
            if (selFoFl == 1)
                {
                try (BufferedWriter bw = new BufferedWriter(new FileWriter("C:\\Projects\\testSeleniumFramework\\framework\\runSelectedTests.bat")))
