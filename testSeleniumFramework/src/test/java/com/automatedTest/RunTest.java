...
import com.automatedTest.extensions.RunTestFunctions;
...
public class RunTest {
    ...
    public static void main(String[] args) {
       try{
           ...
           if (args == null || args.length==0) {
               ...
               String filenameName="demo/Quick.html";   //have to give the absolute path
    ...
    public static void runFailedTest(String strDefaultPath,String strOriginalInputFile){
        ...
        String strFailedTestList=RunTestFunctions.getListOfFailedTestsForFolder(System.getProperty("concordion.output.dir"),strOriginalInputFile);
