package com.automatedTest.extensions;
...
import static com.automatedTest.engine.Test.setDriver;
...
public class RunTestFunctions {
    ...
    public void testFailedListStuff  (){
        //String myResultPath = "X:\\ITDev\\QualityAssurance\\Selenium Results\\R33\\R33 QA2";
        //String myFolderPath = "SmokeTests";
        //System.out.println(getListOfFailedTestsForFolder(myResultPath, myFolderPath));


        ScriptEngineManager factory = new ScriptEngineManager();
        ScriptEngine engine = factory.getEngineByName("JavaScript");
        System.setProperty("webdriver.ie.driver", AppProperties.get("resourcesPath") + "IEDriverServer.exe");
        reportEvent("INFO", "Running testcase in internetexplorer browser");
        DesiredCapabilities cap = DesiredCapabilities.internetExplorer();

        WebDriver myDriver = new InternetExplorerDriver(cap);
        String inputvalue = "apple";


//        int myInt = Integer.parseInt(inputvalue);
//           double myDouble = Double.parseDouble(inputvalue);
...
//        System.out.println(k1.getErrorMessage());
    ...
    public static String getListOfFailedTestsForFolder(String resultPath,String folderPath ){
        ...
        // "X:\ITDev\QualityAssurance\Selenium Results\R33\R33 QA2"
        ...
        String classPathTopLevel = "\\com\\thomsonreuters\\selenium\\automatedTest";
