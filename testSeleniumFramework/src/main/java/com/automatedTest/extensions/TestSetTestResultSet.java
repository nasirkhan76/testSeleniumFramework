...
public class TestSetTestResultSet {
    ...
    private String topLevelResultsName = "Overall Test Run Results"; // This should match the title in the html file test/specs/com/automatedTest/AutomatedTest.html
